package CONFIG_PKG_NAME.database;
...
import CONFIG_PKG_NAME.util.ApplicationUtil;
import CONFIG_PKG_NAME.util.DebugUtil;
import CONFIG_PKG_NAME.util.FileUtil;

public class DatabaseCore extends SQLiteOpenHelper {
private static String DB_PATH = "/data/data/CONFIG_PKG_NAME/databases/";

private static String DB_NAME = "CONFIG_DB_NAME.sqlite";
private static String DB_VERSION = "CONFIG_DB_NAME_version";
